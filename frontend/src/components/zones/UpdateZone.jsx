...
//     try {
//       const res = await axios.get(`/api/v1/zones/${cityId}/${departmentId}`, {
...
//   // Fill form when a zone is selected
...
//     // Convert coordinates for GeoJSON and close polygon
//     let coords = updatedBoundary.coordinates?.[0]?.map(([lat, lng]) => [lng, lat]);
//     if (coords && coords.length > 0 && (coords[0][0] !== coords[coords.length - 1][0] || coords[0][1] !== coords[coords.length - 1][1])) {
...
//                 <p>
//                   <strong>Boundary type:</strong> {updatedBoundary.type || "Polygon"}
//                 </p>
//                 <p>
//                   <strong>Coordinates:</strong> {updatedBoundary.coordinates?.[0]?.length || 0} points
//                 </p>
//               </div>
//             )}
//           </div>
