...
const GetZones = () => {
  ...
  const fetchZones = async () => {
    try {
      ...
      const res = await axios.get(`/api/v1/zones/${departmentId}`, {
...
// // Helper component to fly to a position
// const FlyTo = ({ position }) => {
//   const map = useMap();
//   useEffect(() => {
//     if (position) {
...
//   const [zones, setZones] = useState([]);
//   const [loading, setLoading] = useState(true);
//   const [selectedPosition, setSelectedPosition] = useState(null); // For flying to zone
...
//   // Map center: default to first zone or fallback
//   const defaultCenter = zones.length
//     ? [
//         zones[0].geographical_boundary.coordinates[0][0][1],
//         zones[0].geographical_boundary.coordinates[0][0][0],
...
//   const handleListClick = (zone) => {
//     const firstPoint = zone.geographical_boundary.coordinates[0][0];
//     setSelectedPosition([firstPoint[1], firstPoint[0]]);
//   };
