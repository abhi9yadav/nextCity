      ...
      <div className="bg-white shadow-lg rounded-2xl p-8 w-full max-w-md">
        ...
        >
          <svg className="w-5 h-5" viewBox="0 0 48 48">
            <path
              fill="#EA4335"
              d="M24 9.5c3.54 0 6.71 1.22 9.21 3.6l6.85-6.85C35.9 2.38 30.47 0 24 0 14.62 0 6.51 5.38 2.56 13.22l8.11 6.28C12.09 13.42 17.63 9.5 24 9.5z"
            ></path>
            <path
              fill="#4285F4"
              d="M46.98 24.55c0-1.57-.15-3.09-.42-4.55H24v9.02h12.94c-.58 2.96-2.26 5.48-4.78 7.18l7.73 6c4.53-4.18 7.12-10.31 7.12-17.65z"
            ></path>
            <path
              fill="#FBBC05"
              d="M10.67 28.18C10.24 26.83 10 25.41 10 24s.24-2.83.67-4.18l-8.11-6.28C.96 16.29 0 20.03 0 24s.96 7.71 2.56 10.42l8.11-6.24z"
            ></path>
            <path
              fill="#34A853"
              d="M24 48c6.48 0 11.93-2.13 15.89-5.82l-7.73-6c-2.15 1.45-4.92 2.3-8.16 2.3-6.36 0-11.9-3.92-13.84-9.22l-8.11 6.28C6.51 42.62 14.62 48 24 48z"
            ></path>
