const navConfig = {
  citizen: [
    ...
    {
      name: "Complaint",
      href: "/citizen-dashboard/create-complaint",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mx-auto" viewBox="0 0 24 24" fill="currentColor">
  ...
  department_admin: [
    { name: "Dashboard", href: "/department-admin", icon: "📊" },
    { name: "Complaints", href: "/department-admin/complaints", icon: "📋" },
    { name: "Team", href: "/department-admin/team", icon: "👨‍🔧" },
    { name: "Profile", href: "/department-admin/profile", icon: "👤" },
  ],
