...
import { MorphSVGPlugin } from 'gsap/MorphSVGPlugin'; // Requires Club GreenSock membership

const Animated404Page = () => {
    // useLayoutEffect is preferred for DOM manipulations to prevent screen flicker
    useLayoutEffect(() => {
        ...
        // --- Timelines (updated to GSAP v3 syntax) ---
    ...
    const styles = `
        ...
        #yetiSVG, #lightSVG {
            ...
            top: 50%;
            left: 50%;
            transform: translate(-75%, -50%); /* Adjust positioning */
            overflow: visible;
        }
        .content-404 {
            max-width: 400px;
            ...
            color: #FFF;
            margin-left: 50%; /* Position content to the right */
        }
        .content-404 h3 {
            margin: 0 0 0.8rem;
            font-size: 2.625rem;
    ...
    // All HTML from the original file is converted to JSX below
    return (
        <>
            <style>{styles}</style>
